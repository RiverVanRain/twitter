...
$script_url = "<a class=\"twitter-timeline\"  href=\"https://twitter.com/" . urlencode($username) . "/favorites\"  data-widget-id=\"" . $widget_id ."\">Favorite Tweets by @" . urlencode($username) . "</a>";
